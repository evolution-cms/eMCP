...
#[Description('Read previous siblings of a content node (lower menuindex in same parent).')]
class ContentPrevSiblingsTool extends BaseContentTool
{
    /**
