...
#[Description('Read child nodes by menuindex position range for a parent node.')]
class ContentChildrenRangeTool extends BaseContentTool
{
    /**
    ...
    protected function queryStage(array $validated): mixed
    {
        ...
        $query = SiteContent::query()
            ->select('site_content.*')
            ->childrenRangeOf($args->id, $args->from, $args->to)
