...
#[Description('Read next siblings of a content node (higher menuindex in same parent).')]
class ContentNextSiblingsTool extends BaseContentTool
{
    /**
